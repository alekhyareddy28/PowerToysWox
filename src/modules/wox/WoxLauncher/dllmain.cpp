...
const static wchar_t* MODULE_NAME = L"WoxLauncher";
...
class WoxLauncher : public PowertoyModuleIface {
private:
  // The PowerToy state.
...
void WoxLauncher::init_settings() {
  try {
...
/*
void WoxLauncher::save_settings() {
  try {
